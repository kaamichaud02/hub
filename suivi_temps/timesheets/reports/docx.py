"""Génération du rapport hebdomadaire au format Word (.docx)."""
...
def render_docx_report(data, monday):
    ...
    for timesheet in timesheets:
        ...
        p = _styled_para(doc)
        _add_run(p, f"Date: {timesheet.date.strftime('%d/%m/%Y')} (Total: ", bold=True)
    ...
    response['Content-Disposition'] = f'attachment; filename="rapport_semaine_{monday}.docx"'
